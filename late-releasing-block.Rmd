...
new_block_conversion <- blocks_combined_type %>%
  ...
  group_by(Site, Specialty, Department, DEPARTMENT_ID, Provider, PROV_TYPE, ACTIVE_STATUS, Slot.YearMonth, SLOT_LENGTH) %>%
...
order <- c("Site","Department","Specialty","DEPARTMENT_ID","Provider","PROV_TYPE", "ACTIVE_STATUS", "Slot.YearMonth", "SLOT_LENGTH",
