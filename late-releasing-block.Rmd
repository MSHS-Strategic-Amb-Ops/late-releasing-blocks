...
new_pt_waitTime <- access_raw_tbl %>%
  ...
  group_by(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, DEPARTMENT_ID, PROV_ID, PROV_NAME_WID, Appt.Made.YearMonth, waitTime_14days) %>%
  summarise(total = n()) %>%
  collect() %>%
...
reactable(
  new_pt_waitTime %>%
    dplyr::select(MSHS, SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, DEPARTMENT_ID, PROV_ID, PROV_NAME_WID, Provider, Appt.Made.YearMonth, total_new_scheduled, Yes, No, perc_14days),
  ...
  groupBy = c("MSHS", "SITE", "DEPT_SPECIALTY_NAME", "DEPARTMENT_NAME", "Provider", "Appt.Made.YearMonth"),

  columnGroups = list(
    colGroup(name = "", columns = c("MSHS", "SITE", "DEPT_SPECIALTY_NAME", "DEPARTMENT_NAME", "Provider", "Appt.Made.YearMonth"),
