...
clarity_ser <- clarity_ser %>%
  filter(!is.na(PROV_TYPE)) %>%
  dplyr::select(PROV_ID, PROV_TYPE, PROV_NAME, ACTIVE_STATUS)

# require(openxlsx)
# write.xlsx(clarity_ser, "Clarity Ser.xlsx")
...
late_block_raw <- block_raw_tbl %>%
  ...
  filter(Slot.DateYear >= as.Date("2024-07-01")) %>%
...
reactable(
  ...
  #           }
  #         },
  groupBy = c("MSHS", "Site", "Department", "Specialty", "PROV_TYPE", "Provider", "ACTIVE_STATUS"),
  columns = list(
    Site = colDef(
      name = "Site",
      minWidth = 180),
...
reactable(
  ...
  #           }
  #         },
  groupBy = c("MSHS", "Site", "Department", "Specialty", "PROV_TYPE", "Provider"),
  columns = list(
    Site = colDef(
      name = "Site",
      minWidth = 180),
