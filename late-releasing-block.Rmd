...
block_distribution <- slot_data_prc_tbl %>%
  ...
  left_join(dep_mapping_tbl_loc %>%
            ...
            copy = T) %>%
  filter(is.na(SITE) | SITE %in% c("NETWORK", "MSH-MSDFP", "MSUS", "MSDMG", "MSBI", "MSW", "MSM", "MSH- AMBULATORY CARE", "NYEE", "MSQ", "MSSN", "MSB")) %>%
...
future_block_distribution <- future_block_distribution %>%
...
reactable(
  ...
  groupBy = c("MSHS", "SITE", "DEPT_SPECIALTY_NAME", "DEPARTMENT_NAME", "PROV_NM_WID"),
  ...
  columns = list(
    ...
    perc_reg_openings_new_release = colDef(
      ...
      maxWidth = 100,
      headerStyle = list(background = "#212070", color = "white", fontWeight = "Bold", fontSize = "14px"),
      style = list(background = "#c7c6ef", fontWeight = "Bold"),
    ...
    perc_release_all = colDef(
      ...
      maxWidth = 100,
      headerStyle = list(background = "#d80b8c", color = "white", fontWeight = "Bold", fontSize = "14px"),
      style = list(background = "#fcc9e9", fontWeight = "Bold"),
      # Calculate the aggregate conversion rate as `(total-pending) / total`
      aggregate = JS("function(values, rows) {
...
reactable(
  ...
  groupBy = c("MSHS", "SITE", "DEPT_SPECIALTY_NAME", "DEPARTMENT_NAME", "PROV_TYPE", "PROV_NM_WID"),
