...
late_block_raw <- block_raw_tbl %>%
  ...
  filter(Slot.DateYear >= as.Date("2024-06-01")) %>%
...
new_block_conversion <- blocks_combined_type %>%
  ...
  group_by(Site, Specialty, Department, DEPARTMENT_ID, Provider, PROV_TYPE, Slot.YearMonth) %>%
...
order <- c("Site","Department","Specialty","DEPARTMENT_ID","Provider","PROV_TYPE","Slot.YearMonth",
