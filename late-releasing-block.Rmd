...
block_openings <- block_openings %>%
  ...
  mutate(block_combination_type = 
           ifelse(combination_release == 1, "Combiniation Late-Releasing Blocks", "Combination Non-Late-Releasing Blocks"), .after=block_combination)
...
reactable(
  ...
  columns = list(
    ...
    block_combination_type = colDef(
      name = "Block Combination Type",
      headerStyle = list(background = "#212070", color = "white", fontWeight = "Bold", fontSize = "14px"),
      style = list(borderLeft = "1.5px solid rgb(230, 230, 230)"),
      minWidth = 150),
